...
DOMINO_API_BASE_URL = os.getenv('DOMINO_API_BASE_URL', 'https://<domino-url>/api/projects/beta/projects')
...
def log_diagnostics(new_projects_count, deleted_projects_count):
    diagnostics = {"New Projects Count": new_projects_count, "Deleted Projects Count": deleted_projects_count}
...
def main():
    ...
    new_projects = [project for project in current_projects if project['id'] in new_project_ids]
    deleted_projects = [project for project in previous projects if project['id'] in deleted_project_ids]
    ...
    if new_projects:
        ...
        for project in new_projects:
            print(f"- Name: {project['name']}, ID: {project['id']}, Owner: {project['ownerUsername']}")
    else:
