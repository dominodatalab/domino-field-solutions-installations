...
export NAMESPACES_FILE="${NAMESPACES_FILE:-$SCRIPT_DIR/namespaces_deploy.json}"
...
export BENCHMARK_RESULTS_PATH="${BENCHMARK_RESULTS_PATH:-/domino/datasets/local/triton-grpc-test/benchmarks}"
